...
function myconfirm()
{
	...
	if( select_num < 1 )
		...
		answer = confirm("Are you sure you want to remove " + select_num + " devices from area？");
		if (answer) {
...
<div id="title">Client ／ Area ／ Device ／ Remove</div>

<form id="form" method="post" action="<?=site_url("admin/area_device/r/".$area['area_id']);?>">
