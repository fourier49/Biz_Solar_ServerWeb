...
<head>
	<meta charset="utf-8">
	<title>Solar System Admin Login</title>
</head>
<body align="center">
...
<div style="width:552px; height:390px; background-image:url(<?=base_url('images/admin/login_bg.png');?>); background-repeat:no-repeat;">
