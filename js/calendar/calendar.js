...
var pathToImages = '/PVWEB/images/calendar/';	// Relative to your HTML file
...
function writeCalendarContent()
{
	...
	if(!calendarContentDiv){
		...
		calendarContentDiv.style.borderWidth = "1px";
		calendarContentDiv.style.borderColor = "#FFF";
		calendarContentDiv.style.borderStyle = "solid";
