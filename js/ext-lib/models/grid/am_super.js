...
Ext.onReady(function(){
	...
	function renderEdit(value, p, record) {
        return Ext.String.format(
            '<b><a href="/PVWEB/index.php/home/am/e/0/{0}"><img height=16 src="/PVWEB/images/button/edit.png"/></a></b>',
			record.data.am_id
        );
    }
	
	function renderRemove(value, p, record) {
        return Ext.String.format(
            '<b><a href="javascript:myconfirm({0},' + "'{1}'" + ')"><img src="/PVWEB/images/button/delete.png"/></a></b>',
            record.data.am_id,
			record.data.mac
        );
    }
